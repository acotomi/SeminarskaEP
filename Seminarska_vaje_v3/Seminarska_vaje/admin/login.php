...
// Temporarily disabled SSL check
/*
$client_cert_info = [];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($email && $password) {
        ...
        if ($admin && password_verify($password, $admin['geslo'])) {
            $_SESSION['admin_id'] = $admin['id'];
            $_SESSION['admin_email'] = $admin['email'];
            header('Location: dashboard.php');
            exit;
        } else {
            $error = "Napačni podatki za prijavo.";
        }
    }
}
?>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-center">Administrator Prijava</h3>
                    </div>
                    <div class="card-body">
